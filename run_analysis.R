...
# Getting Directories and files in the project folder provided i.e. UCI HAR Dataset
...
# Getting raw data from features, activity_labels, train/x_train, train/y-train, train/subject_train
# test/x-test, test/y-test, Subject_test
...
write.table(sensor_avg_by_act_sub, file = "GettingCleaningTidyData.txt")
